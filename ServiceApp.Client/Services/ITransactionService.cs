...
namespace ServiceApp.Client.Services
{
    ...
    {
        Task<bool> Process(IClientInfo clientInfo, IAccounting Accounting, IOtherServices OtherServices, IPSA PSAAssistance, IDFA DFAServices, INotary Notary, ILTO LTOServices, IAirline AirlineServices, IVISAProcessing VISAProcessing, IFinancial FinancialServices, IATMPortable ATMPortable);
